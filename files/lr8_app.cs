...
namespace OrderManagementApp
{
    ...
    public class OrderService
    {
        ...
        {
            int minPriceForDiscount = 10000; // минимальная цена для получения скидки
            double discountPercent = 0.1; // процент скидки
			double tax = 0.2; // НДС
			// скидка 10% при заказе от 10000
            double discount = 0;

            discount = (order.Total > minPriceForDiscount) ? order.Total * discountPercent : 0;
			// итоговая цена
